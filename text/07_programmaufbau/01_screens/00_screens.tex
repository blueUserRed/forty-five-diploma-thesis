...
Zusätzlich hat jeder screen einen screen-controller, welcher für die Verwaltung des screens zuständig ist und komplexere Aufgaben in diesem durchführt.
...
\input{text/07_programmaufbau/01_screens/01_widgets.tex}
\input{text/07_programmaufbau/01_screens/02_parameter.tex}
\input{text/07_programmaufbau/01_screens/03_screencontroller.tex}
\input{text/07_programmaufbau/01_screens/04_screenbuilder.tex}