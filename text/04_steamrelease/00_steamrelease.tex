...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{steamworkspartner}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{produkt45}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Steamseite}
    \caption{Steamseite}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Steamprozess}
