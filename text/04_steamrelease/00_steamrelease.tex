...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{steamworkspartner.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{produkt45.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Steamseite.png}
    \caption{Steamseite}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Steamprozess.png}
