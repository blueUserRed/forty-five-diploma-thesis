...
Standardgemäß besteht Scrum aus zeitlich definierten Sprints, welche das Ziel verfolgen, nach jedem Sprint kleine Teilerfolge zu erzielen.\cite{AsanaScrum}
...
Die Testphase teilte sich in kurz dauernde Playtesttasks auf, da es sich oft um schnelle Änderungen und Anpassungen im Spiel bezog, da laufend neue Testdemos entwickelt wurden.
Dazu gehörte das Testen von Spielmechaniken wie Enemy Actions, das Testen von Sounds und die Suche nach Bugs.
