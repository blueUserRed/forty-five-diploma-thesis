...
\inlineCode{null} hat in den meisten Programmiersprachen die Eigenschaft, dass es für alle möglichen Typen einstehen
kann und weist so gewisse Ähnlichkeiten zu einem Bottom-Typen auf. % todo: link zu Nothing-Section
