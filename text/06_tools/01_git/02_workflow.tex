...
\begin{enumerate}
    \item Beim Arbeiten an einer User-Story erstellt man eine branch namens \quoted{ff-xxx-name-of-user-story}.
...
Eine weitere Möglichkeit wären end-to-end Tests, bei denen sich ein Programm im GUI (graphical user interface) durchklickt und so das gesamte Programm aus Sicht des Endnutzers testet.\zit{UnitVsE2E}
