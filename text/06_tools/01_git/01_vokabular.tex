...
\begin{liste}
    ...
    \item main/main-branch: Die Hauptentwicklungslinie, die alle fertigen Features beinhaltet und auch für \quoted{builds} (=eine fertige Applikation, die man auch auf Steam hochladen kann) verwendet wird.
