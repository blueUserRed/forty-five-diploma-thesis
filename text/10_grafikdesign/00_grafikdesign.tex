...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{ereignisseMap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{mapEventsUI.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{hoverdetails.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{enemyAction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{settingsMenu.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{settingsMockup.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{bulletMoodboard.png}
    \caption*{Moodboard Ausschnitt der Bullet Guidelines. Quelle: \url{https://helpcenter.shirtigo.de/wiki/druckmotiv/vektorgrafik/\#:\~:text\=Grundlage\%20einer\%20Vektorgrafik\%20bilden\%20die,wie\%20Kurven\%2C\%20Kreise\%20oder\%20Polygone}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bullet.png}
    \caption{Artwork der normalen Bullet}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{finalBullet.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{bulletTemplate.png}
