...
%TODO EINLEIDTUNG paar sätze ganz grundlegend
%TODO GENDERN????
%TODO rogue like/lite nochmal erklären
%
...
Um das Spielerlebnis des Spielers nicht allzu frustrierend zu gestalten, wurden in \FF zwei verschiedene Mechaniken eingeführt.%TODO MECHANIK erklären
...
wo alle Karten sofort in einer eigenen Liste zugänglich sind), \zit{magicarena}
...
Diese Designpolitik wird beim Design der Karten beachtet und wird zu einem späteren Zeitpunkt genauer erläutert. %TODO macht man das so?
Viele Rogue-like Deckbuilder haben ein ähnliches System. Inspiriert wurde das Sammeln der Karten in \FF von Spielen wie \quoted{Inscription} und \quoted{Slay the Spire},
hat jedoch einen großen Unterschied. Anders als in \zB \quoted{Slay the Spire} können Karten ganz einfach aus dem Kartendeck entfernt werden, nachdem sie einmal ausgewählt wurden.
...
wenn sie im Revolver rotiert.%TODO BILD BEWITCHED BULLET UND BULL ET
...
Die Gegner sind entstanden durch das beobachten von Spielen im selben Genre, wie zum Beispiel  \quoted{Slay the Spire}. \zit{slaythespire}
