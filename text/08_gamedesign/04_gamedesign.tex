...
Der Statuseffekt "Burning" zum Beispiel, erhöht den Schaden der nächsten paar Bullets um 50\%.
...
Wenn ein Effekt einer Bullet also "On-Rotate" auslöst, ist er in vielen Decks spielbar und nicht nur in Decks
...
\begin{figure}[H]
    \includegraphics[width=50\%]{highVB.png}
...
\begin{figure}[H]
    \includegraphics[width=50\%]{deputiesB.png}
...
\begin{figure}[H]
    \includegraphics[width=50\%]{purgeB.png}
...
\begin{figure}[H]
    \includegraphics[width=50\%]{workerB.png}
...
\begin{figure}[H]
    \includegraphics[width=50\%]{turtleB.png}
