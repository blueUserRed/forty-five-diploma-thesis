...
\quoted{High Velocity Bullet} ist eine ein Kosten, null Schaden Karte, die über den Effekt verfügt, dass sie dem Gegner Schaden zufügt, wenn sie den Revolver verlässt, auch \quoted{On-Leave} Trigger genannt.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{highVB}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{deputiesB}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{purgeB}
...
Das Deckdesign in \FF basiert auf dem eigens eingeführten, sogenannten \quoted{Drei Säulen Modell}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{workerB}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{turtleB}
