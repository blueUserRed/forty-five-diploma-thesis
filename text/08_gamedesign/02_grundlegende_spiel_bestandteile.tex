...
%TODO COMBO erklären
%TODO Run erklären
%TODO hovern erklären
%TODO QWort Mechanik erklären
%TODO kapitel umbennenin grundelgene bestandteile des SPieles
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{choosebullet.png}%TODO bild schneiden
...
\end{figure}%TODO description

\subsection{Backpack und Deck}\label{backpack_and_deck}
\begin{infoBox}%TODO INFOBOX WEG und dann drüber
...
wenn sie im Revolver rotiert und profitiert damit von der Linksdrehung von Bewitched Bullet.%TODO BILD BEWITCHED BULLET UND BULL ET
...
sondern löst auch gleichzeitig folgendes Problem: In \FF ist der Aufbau des Revolvers und damit von Combos sehr wichtig.%TODO erklärung für combo
