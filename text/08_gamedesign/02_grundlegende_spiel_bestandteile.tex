...
Der Spieler bewegt sich über eine Map, die immer wieder neu generiert wird, sammelt Karten und benutzt diese Karten,
...
\zit{roguelikedeckbuilder, liteandlike}



\begin{infoBox}
    Zu diesem Zeitpunkt geht es nicht um die Designprinzipien hinter Bestandteilen,
...
Um das Spielerlebnis des Spielers nicht allzu frustrierend zu gestalten, werden in \FF zwei verschiedene Mechaniken eingeführt.
...
Dies dient dazu, dem Spieler die Entscheidung offen zu halten, entweder in etwas Langfristiges aber Bleibendes zu investieren oder lieber noch einmal ordentlich
Lebenspunkte aufzutanken, was bei der zweiten Mechanik ins Spiel kommt.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{healeventgrafic}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bulletssavedPopup}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{bulletsaved}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{choosebullet}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{deckandbackpack}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{deckview}
    \caption{Beispiel: Ansicht eines Decks und des Backpacks}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{deckchoose}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{sortdeck}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{playericon}
...
Ein Kampf ist aufgeteilt in Züge. Immer abwechselnd ist entweder der Spieler oder der Gegner an der Reihe. Am Anfang des Kampfes
wird eine vordefinierte Anzahl an Karten vom Deck des Spielers gezogen.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bewitched_Bullet}
    \caption{Beispiel: Bewitched Bullet}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{bull_et}
