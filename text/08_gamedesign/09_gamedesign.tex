...
jedoch stößt er mit der Zeit auf Deputies Bullet. Deputies Bullet hat den effekt, dass wen sie im Revolver platziert wird
...
eine bewisste Entscheidung die später noch einmal ins Spiel kommt. Kombiniert mit High Velocity Bullet, kann der eher
...
Dieser relativ abgesonderte Rachetype, kann trptzdem mit on-Leave Effekten kombiniert werden, was wiederum das breite Karten design von \FF veranschaulicht.

%destroy und auch das die karten zuerst als etwas negatives gesehen werden und sich der wert später zeigt.
%wichtig, da der spieler nach und dnach die ganzen möglcihkeiten erkundet und lernt.
