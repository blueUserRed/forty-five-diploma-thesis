...
Unter Funktion versteht man, wie das Spiel gespielt wird, was Regeln und Mechaniken einschließt. \cite{flavorAndFunction}
...
Im \FF zum Beispiel ist das Spielfeld der Revolver. Vielen Spielern wird bereits bewusst sein, dass man Kugeln in einen
Revolver lädt und da alle Karten Kugeln sind, kann sich der Spieler denken, was er zu tun hat. Die Mechanik des Ladens
...
Zitate von verschiedenen Charakteren in der Magic-Welt wieder.\cite{magicarena,soulOfTheGame} %TODO Bild
...
von Gold Bullet ist. Es werden also Eigenschaften von Gold, nämlich dass es immer mehr wert wird, je länger man es besitzt,
