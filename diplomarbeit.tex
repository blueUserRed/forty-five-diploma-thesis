...
\input{text/latex_shortcuts.tex}
...
\input{text/general/kurzfassung.tex}

\chapter{Abstract}
\selectlanguage{english}
\input{text/general/abstract.tex}
...
\makeatother
\unchapter{Ehrenwörtliche Erklärung}
\includepdf[pages=-]{erklaerung_unterschrieben.pdf}

%\chapter{Ehrenwörtliche Erklärung}
%\input{text/general/erklaerung.tex}
...
\input{text/01_projektmanagement/00_projektmanagement.tex}
\input{text/02_marketing/00_marketing.tex}
\input{text/05_kotlin/00_kotlin.tex}
\input{text/06_tools/00_tools.tex}
\input{text/08_gamedesign/00_gamedesign.tex}
\input{text/07_programmaufbau/00_programmaufbau.tex}
\input{text/03_sounds/00_sounds.tex}
\input{text/10_grafikdesign/00_grafikdesign.tex}
\input{text/04_steamrelease/00_steamrelease.tex}
\input{text/09_lizenzen/00_lizenzen.tex}

\appendix

\input{text/anhänge/00_anhänge.tex}
