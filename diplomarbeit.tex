...
\usepackage{fontspec}
\setmainfont{Bahnschrift.ttf} % todo: bahnschrift as main font might be a bad decision
\newfontfamily\headingfont[]{Redwing-medium.otf}
\newfontfamily\codefont{JetBrains Mono Regular Nerd Font Complete Mono Windows Compatible.ttf}[NFSSFamily=JetBrainsMonoFamily]
\setkomafont{chapter}{\headingfont}
\setkomafont{section}{\headingfont}
\setkomafont{subsection}{\headingfont}
...
\input{text/code_listings_test.tex}
